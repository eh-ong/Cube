...
<div class="card-header py-3">
	...
	<label class="m-0 text-secondary">완료함</label>
...
<div class="justify-content-end">
  ...
  <h2 class="h4 text-gray-900 font-weight-bold">완료한 프로젝트</h2>
...
<br>
  <table class="table table-bordered text-gray-900" style="width: 100%; cellspacing: 0">
    ...
    <c:forEach var="project" items="${projectList}">
	    <c:if test="${project.projectStatus eq '완료'}">
	        ...
	        <tr>
	           ...
	           <td style="font-weight: bold;">${project.projectStatus}</td>
	        </tr>
        </c:if>
    </c:forEach>
</tbody>
