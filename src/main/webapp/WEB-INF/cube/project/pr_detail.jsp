		...
		<div style="margin-left:1.5%;">				
		    ...
		    <c:forEach var="prProgress" items="${prProgressList}">
			        ...
			        <tr>
			           ...
			           <c:choose>
						    <c:when test="${login_user == prProgress.prProgressWriter && project.projectStatus eq '진행중'}">						    
						        <td><a href="/pr_updatePrProgressPage/${project.projectId }/${prProgress.prProgressId}"><i class="fas fa-pen" style="color: blue;"></i></a></td>
						        <td><button id="btn-deletePrProgress" class="btn btn-center"><i class="fas fa-trash" style="color: blue;"></i></button></td>
						    </c:when>
						    <c:otherwise>
						        <td></td>
						        <td></td>
