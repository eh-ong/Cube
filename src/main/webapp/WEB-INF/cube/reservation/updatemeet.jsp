			...
			<div class="card-body">
				...
				<div class="form-group">
					<label for="selectedDate">날짜 선택:</label> <input type="date"
						id="selectedDate" class="form-control"  style="width: 50%;" name="selectedDate"
				...
				<div class="form-group">
					<label for="reStart">시작 시간:</label> <select id="reStart"
						name="reStart" class="form-control" style="width: 50%;" required>
				...
				<div class="form-group">
					<label for="mrSelect">회의실 선택:</label> <select id="mrSelect"
						name="mrSelect" class="form-control"  style="width: 50%;" required>
